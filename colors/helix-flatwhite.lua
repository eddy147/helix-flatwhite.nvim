...
local hl = {
	...
	["@function"] = { fg = p.black_text, bold = true },
	["@function.call"] = { fg = p.black_text, bold = false },
	["@function.method"] = { fg = p.black_text, bold = false },
	["@function.method.call"] = { fg = p.black_text, bold = false },
	["@constructor"] = { fg = p.base1 },
	["@operator"] = { fg = p.black_text },
	...
	["@lsp.type.function"] = { fg = p.black_text, bold = true },
	["@lsp.type.method"] = { fg = p.black_text, italic = true },
